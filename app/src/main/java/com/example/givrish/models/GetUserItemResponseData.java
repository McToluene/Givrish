...
public class GetUserItemResponseData implements Parcelable {
    ...
    public static final Creator<GetUserItemResponseData> CREATOR = new Creator<GetUserItemResponseData>() {
        @Override
        public GetUserItemResponseData createFromParcel(Parcel in) {
            return new GetUserItemResponseData(in);
        }

        @Override
        public GetUserItemResponseData[] newArray(int size) {
            return new GetUserItemResponseData[size];
        }
    };
